...
/**   
 * <p>
 * Description:获取指定包下指定注解的class<br />
 * </p>
 * @author Bill Chan
 * @date 2017年6月2日 上午11:23:36
 */
public class LoadPackageClasses {
	
    protected final Logger LOGGER = LoggerFactory.getLogger(LoadPackageClasses.class);
	...
	/**
	 * <p>
	 * Description:将符合条件的Bean以Class集合的形式返回<br />
	 * </p>
	 * @author Bill Chan
	 * @date 2017年6月2日 下午2:12:11
	 * @return
	 * @throws IOException
	 ...
	 * 
	 * <p>
	 * Description:检查当前扫描到的Bean含有任何一个指定的注解标记<br />
	 * </p>
	 * @author Bill Chan
	 * @date 2017年6月2日 下午12:22:38
	 * @param reader
	 * @param readerFactory
	 * @return
	 * @throws IOException
