...
public class HttpClientUtils {
    ...
    public static String postTextParameters(String url, String parameterStr) throws ConnectTimeoutException, SocketTimeoutException, Exception{
        return post(url,parameterStr,"text/plain",charset,connTimeout,readTimeout);
    }

    public static String headerPost(String url, String parameterStr,Map<String,String> header) throws ConnectTimeoutException, SocketTimeoutException, Exception{
        return headerPost(url,parameterStr,header,"application/json",charset,connTimeout,3000);
    }
    ...
    public static String headerPost(String url, String body,Map<String,String> header, String mimeType,String charset, Integer connTimeout, Integer readTimeout)
            throws ConnectTimeoutException, SocketTimeoutException, Exception {
        HttpClient client = null;
        HttpPost post = new HttpPost(url);
        String result = "";
        try {
            ...
            if(null!=header && header.size()>0){
                for(String str : header.keySet()){
                    post.setHeader(str,header.get(str));
                }
            }
            HttpResponse res;
            if (url.startsWith("https")) {
